...
const MAIN_REALIZE_FILE = 'docs\\index.html'
...
const watchChanges = () => {
    info('watch changes');
    const watchFiles = oof.getAllHtmlFiles('src', ['index.html', 'fonts'])
    // console.log('%c watchFiles.watch:', 'background: #ffcc00; color: #003300', watchFiles.watch)
    watch(
        watchFiles,
        () => {
            setTimeout(() => {
